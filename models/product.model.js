...
class Product {
  ...
  async save() {
    ...
    if (this.id) {
      ...
      if(!this.image){
        delete productData.image;//removes the image key value pair from productData object. Because we don't want to insert undefined value into image of our db.
      }
     await db.getDb()
        .collection("products")
