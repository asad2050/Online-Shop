const Product = require('./pg.product.model');
class Cart{
    ...
    updateItem(productId, newQuantity){
        ...
        if(item.product.id===productId && newQuantity>0)

            {
                ...
                const cartItem ={...item};
                const quanitityChange = newQuantity- item.quantity;
                cartItem.quantity= newQuantity;
           
            cartItem.totalPrice= newQuantity* item.product.price;
            this.items[i]= cartItem;
            this.totalQuantity= this.totalQuantity+ quanitityChange;
            this.totalPrice+= quanitityChange * item.product.price;
